...
- Contrato de independência documentado, templates de colaboração e smoke tests Playwright.
...
- Documentação raiz descreve os dois projetos como entradas autônomas e sem seletor de jogo.
- Modal do modo professor mantém o botão de fechamento acessível em telas de menor altura.

### Removed

- Página raiz de escolha de jogo e dependências visuais compartilhadas entre as duas pastas.
